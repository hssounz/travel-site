...
var MobileMenu = /*#__PURE__*/_createClass(function MobileMenu() {
  ...
  _defineProperty(this, "event", function () {
    _this.menuIcon.click(function (e) {
      _this.menuContentMobile.toggleClass('nav__visible');
      _this.menuIcon.toggleClass('nav__menu-icon__close');
    });
  });
  this.menuIcon = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.nav__menu-icon');
  this.menuContentMobile = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.nav__menu-content-mobile');
  this.event();
});
...
var RevealOnScroll = /*#__PURE__*/_createClass(function RevealOnScroll() {
  var _this = this;
  _classCallCheck(this, RevealOnScroll);
  _defineProperty(this, "handleFeatures", function () {
